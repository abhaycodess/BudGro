...
const StyledWrapper = styled.div`
  ...
  .theme__toggle {
    ...
    border-radius: 25% / 50%;
    box-shadow: 0 0 0 0.125em #2F80ED22;
    padding: 0.25em;
    width: 6em;
    height: 3em;
  ...
  .theme__toggle:focus {
    box-shadow: 0 0 0 0.125em #2F80ED;
    outline: transparent;
  }
  ...
  @supports selector(:focus-visible) {
    .theme__toggle:focus { box-shadow: 0 0 0 0.125em #2F80ED22; }
    .theme__toggle:focus-visible { box-shadow: 0 0 0 0.125em #2F80ED; }
  }
`;
